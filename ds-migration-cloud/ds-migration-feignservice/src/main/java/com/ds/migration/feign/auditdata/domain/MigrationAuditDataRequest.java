...
@JsonPropertyOrder({ "recordId", "processId", "auditEntryDateTime", "recordPhaseStatus", "recordPhase" })
public class MigrationAuditDataRequest implements MigrationInformation {
