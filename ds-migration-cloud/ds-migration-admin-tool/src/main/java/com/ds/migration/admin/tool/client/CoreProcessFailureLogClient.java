package com.ds.migration.admin.tool.client;
...
@FeignClient(contextId = "coreProcessFailureLogClient", value = "dsmigrationcoredata", configuration = FeignClientConfiguration.class)
